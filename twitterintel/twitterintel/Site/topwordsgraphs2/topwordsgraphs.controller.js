(function () {
    ...
    angular
        .module('app')
        .controller('TopwordsgraphsController2', TopwordsgraphsController2);

    TopwordsgraphsController2.$inject = ['$location', 'GraphsService', '$rootScope'];
    function TopwordsgraphsController2($location, GraphsService , $rootScope) {
        var vm = this;
