...
class TwitterAnalyze:
    def __init__(self,bad,good,spam,bad2,good2,spam2,bad3,good3,spam3,tracker):
        ...
        stream = tweepy.Stream(auth, TwitterListener(bad,good,spam,bad2,good2,spam2,bad3,good3,spam3))
        stream.filter(track=[tracker])
        
class TwitterListener(tweepy.StreamListener):
    def __init__(self,bad,good,spam,bad2,good2,spam2,bad3,good3,spam3):
